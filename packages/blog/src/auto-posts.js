...
},
{
  ...
  component: lazy(() => import('./posts/2019/july/theme-first-ui-development.mdx'))
},
{
  to: 'deploying-automatically-using-github-actions',
  title: 'Deploying Automatically using GitHub Actions',
  component: lazy(() => import('./posts/2019/june/deploying-with-github-actions.mdx'))
},
{
...
{
  to: 'hooks-tips-ep.-2---migrating-instance-variables"',
  title: 'Hooks Tips Ep. 2 - Migrating Instance Variables"',
  component: lazy(() => import('./posts/2019/february/hooks-tips-instance-variables.mdx'))
},
{
...
{
  to: 'usereducer,-don't-usestate',
  title: 'useReducer, don't useState',
  component: lazy(() => import('./posts/2019/february/why-you-should-useReducer.mdx'))
},
{
  to: 'hooks-tips-ep.-1---the-dependency-array"',
  title: 'Hooks Tips Ep. 1 - The Dependency Array"',
  component: lazy(() => import('./posts/2019/february/hooks-tips-dependency-array.mdx'))
},
{
  to: 'building-a-live-editor',
  title: 'Building a Live Editor',
  component: lazy(() => import('./posts/2019/february/building-a-live-editor.mdx'))
},
{
  to: 'react-error-boundaries',
  title: 'React Error Boundaries',
  component: lazy(() => import('./posts/2019/january/react-error-boundaries.mdx'))
},
{
  to: 'testing-software',
...
},
{
  ...
  component: lazy(() => import('./posts/2016/january/my-first-project-of-2016.mdx'))
},
{
  to: 'dji-vs-gopro',
  title: 'DJI vs GoPro',
...
},
{
  ...
  component: lazy(() => import('./posts/2016/august/attribute-selectors.mdx'))
},
{
  to: 'redesign',
  title: 'Redesign',
...
},
{
  ...
  component: lazy(() => import('./posts/2015/december/blogging-vs-working.mdx'))
},
{
  to: '2015',
  title: '2015',
