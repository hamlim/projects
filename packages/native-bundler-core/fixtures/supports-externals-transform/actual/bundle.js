...
var _reactDomDevelopment = _interopRequireDefault(require("fixtures/supports-externals-transform/actual/_vendor_/react-dom.development.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log(_reactDomDevelopment.default);
},
{"fixtures/supports-externals-transform/actual/_vendor_/react-dom.development.js":1}
],1: [
function(require, module, exports) {
...
(async function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(await import('https://mh-unumd.glitch.me/@matthamlin/danger-react-suspense/dev/react.js?exports=named')) :
	typeof define === 'function' && define.amd ? define(['react'], factory) :
	(global.ReactDOM = factory(global.React));
}(this, (async function (React) { 'use strict';
...

{
  warningWithoutStack = function (condition, format) {
    ...
    if (typeof console !== 'undefined') {
      var argsWithFormat = args.map(async function (item) {
        return '' + item;
      });
...
'defaultValue', 'defaultChecked', 'innerHTML', 'suppressContentEditableWarning', 'suppressHydrationWarning', 'style'].forEach(async function (name) {
...
[['acceptCharset', 'accept-charset'], ['className', 'class'], ['htmlFor', 'for'], ['httpEquiv', 'http-equiv']].forEach(async function (_ref) {
  var name = _ref[0],
...
['contentEditable', 'draggable', 'spellCheck', 'value'].forEach(async function (name) {
...
['autoReverse', 'externalResourcesRequired', 'focusable', 'preserveAlpha'].forEach(async function (name) {
  properties[name] = new PropertyInfoRecord(name, BOOLEANISH_STRING, false, // mustUseProperty
  name, // attributeName
  null);
} // attributeNamespace
...
// Microdata
'itemScope'].forEach(async function (name) {
...
'multiple', 'muted', 'selected'].forEach(async function (name) {
...
['capture', 'download'].forEach(async function (name) {
...
['cols', 'rows', 'size', 'span'].forEach(async function (name) {
...
['rowSpan', 'start'].forEach(async function (name) {
...
['accent-height', 'alignment-baseline', 'arabic-form', 'baseline-shift', 'cap-height', 'clip-path', 'clip-rule', 'color-interpolation', 'color-interpolation-filters', 'color-profile', 'color-rendering', 'dominant-baseline', 'enable-background', 'fill-opacity', 'fill-rule', 'flood-color', 'flood-opacity', 'font-family', 'font-size', 'font-size-adjust', 'font-stretch', 'font-style', 'font-variant', 'font-weight', 'glyph-name', 'glyph-orientation-horizontal', 'glyph-orientation-vertical', 'horiz-adv-x', 'horiz-origin-x', 'image-rendering', 'letter-spacing', 'lighting-color', 'marker-end', 'marker-mid', 'marker-start', 'overline-position', 'overline-thickness', 'paint-order', 'panose-1', 'pointer-events', 'rendering-intent', 'shape-rendering', 'stop-color', 'stop-opacity', 'strikethrough-position', 'strikethrough-thickness', 'stroke-dasharray', 'stroke-dashoffset', 'stroke-linecap', 'stroke-linejoin', 'stroke-miterlimit', 'stroke-opacity', 'stroke-width', 'text-anchor', 'text-decoration', 'text-rendering', 'underline-position', 'underline-thickness', 'unicode-bidi', 'unicode-range', 'units-per-em', 'v-alphabetic', 'v-hanging', 'v-ideographic', 'v-mathematical', 'vector-effect', 'vert-adv-y', 'vert-origin-x', 'vert-origin-y', 'word-spacing', 'writing-mode', 'xmlns:xlink', 'x-height'].forEach(async function (attributeName) {
...
['xlink:actuate', 'xlink:arcrole', 'xlink:href', 'xlink:role', 'xlink:show', 'xlink:title', 'xlink:type'].forEach(async function (attributeName) {
  var name = attributeName.replace(CAMELIZE, capitalize);
  properties[name] = new PropertyInfoRecord(name, STRING, false, // mustUseProperty
...
['xml:base', 'xml:lang', 'xml:space'].forEach(async function (attributeName) {
  var name = attributeName.replace(CAMELIZE, capitalize);
  properties[name] = new PropertyInfoRecord(name, STRING, false, // mustUseProperty
...
interactiveEventTypeNames.forEach(async function (eventTuple) {
  addEventTypeNameToConfig(eventTuple, true);
});
nonInteractiveEventTypeNames.forEach(async function (eventTuple) {
...
var createMicrosoftUnsafeLocalFunction = function (func) {
  if (typeof MSApp !== 'undefined' && MSApp.execUnsafeLocalFunction) {
    return function (arg0, arg1, arg2, arg3) {
      MSApp.execUnsafeLocalFunction(async function () {
 ...
 * @internal
 */
var setInnerHTML = createMicrosoftUnsafeLocalFunction(async function (node, html) {
...
Object.keys(isUnitlessNumber).forEach(async function (prop) {
...
function warnInvalidARIAProps(type, props) {
  ...
  var unknownPropString = invalidProps.map(async function (prop) {
    return '`' + prop + '`';
  }).join(', ');
...
var warnUnknownProperties = function (type, props, canUseEventSystem) {
  ...
  var unknownPropString = unknownProps.map(async function (prop) {
    return '`' + prop + '`';
  }).join(', ');
...

{
  ...
  warnForExtraAttributes = function (attributeNames) {
    ...
    didWarnInvalidHydration = true;
    var names = [];
    attributeNames.forEach(async function (name) {
      names.push(name);
    });
...
function injectInternals(internals) {
  ...
  try {
    ...
    onCommitFiberRoot = catchErrors(async function (root) {
      return hook.onCommitFiberRoot(rendererID, root);
    });
    onCommitFiberUnmount = catchErrors(async function (fiber) {
...

{
  ...
  ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function () {
    pendingUnsafeLifecycleWarnings.forEach(async function (lifecycleWarningsMap, strictRoot) {
      var lifecyclesWarningMesages = [];

      Object.keys(lifecycleWarningsMap).forEach(async function (lifecycle) {
        var lifecycleWarnings = lifecycleWarningsMap[lifecycle];
        if (lifecycleWarnings.length > 0) {
          var componentNames = new Set();
          lifecycleWarnings.forEach(async function (fiber) {
  ...
  ReactStrictModeWarnings.flushPendingDeprecationWarnings = function () {
    if (pendingComponentWillMountWarnings.length > 0) {
      ...
      pendingComponentWillMountWarnings.forEach(async function (fiber) {
    ...
    if (pendingComponentWillReceivePropsWarnings.length > 0) {
      ...
      pendingComponentWillReceivePropsWarnings.forEach(async function (fiber) {
    ...
    if (pendingComponentWillUpdateWarnings.length > 0) {
      ...
      pendingComponentWillUpdateWarnings.forEach(async function (fiber) {
  ...
  ReactStrictModeWarnings.recordUnsafeLifecycleWarnings = function (fiber, instance) {
    ...
    if (unsafeLifecycles.length > 0) {
      unsafeLifecycles.forEach(async function (lifecycle) {
  ...
  ReactStrictModeWarnings.flushLegacyContextWarning = function () {
    pendingLegacyContextWarning.forEach(async function (fiberArray, strictRoot) {
      var uniqueNames = new Set();
      fiberArray.forEach(async function (fiber) {
        uniqueNames.add(getComponentName(fiber.type) || 'Component');
...
function useImperativeMethods(ref, create, inputs) {
  ...
  useLayoutEffect(async function () {
    ...
    default:
      {
        ...
        var _thenable = ctor();
        _thenable.then(async function (moduleObject) {
...
function ChildReconciler(shouldTrackSideEffects) {
  ...
  function reconcileChildrenArray(returnFiber, currentFirstChild, newChildren, expirationTime) {
    ...
    if (shouldTrackSideEffects) {
      ...
      existingChildren.forEach(async function (child) {
    ...
    case SuspenseComponent:
      {
        ...
        if (thenables !== null) {
          ...
          thenables.forEach(async function (thenable) {
...
function commitRoot(root, finishedWork) {
  ...
  if (enableSchedulerTracing) {
    ...
    try {
      ...
      pendingInteractionMap.forEach(async function (scheduledInteractions, scheduledExpirationTime) {
        ...
        if (scheduledExpirationTime > earliestRemainingTimeAfterCommit) {
          ...
          scheduledInteractions.forEach(async function (interaction) {
            interaction.__count--;
...
function renderRoot(root, isYieldy) {
  ...
  if (expirationTime !== nextRenderExpirationTime || root !== nextRoot || nextUnitOfWork === null) {
    ...
    if (enableSchedulerTracing) {
      ...
      root.pendingInteractionMap.forEach(async function (scheduledInteractions, scheduledExpirationTime) {
    ...
    if (root !== null) {
      ...
      if (interactions.size > 0) {
        ...
        if (pendingInteractions != null) {
          interactions.forEach(async function (interaction) {
...
function legacyRenderSubtreeIntoContainer(parentComponent, children, container, forceHydrate, callback) {
  ...
  if (!root) {
    ...
    unbatchedUpdates(async function () {
